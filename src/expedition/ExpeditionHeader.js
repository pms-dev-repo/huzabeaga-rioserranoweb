...
function ExpeditionHeader({title, text, image}){
  return(
    <Section id="headerExpedition">
      <SectionHeader>
        <Title>{title}</Title>
      </SectionHeader>
      <SectionBgImage data-scroll data-scroll-speed="-3" data-scroll-position="top" data-scroll-target="#headerExpedition" image={image}/>
      <SectionGradient />
    </Section>
  )
}
